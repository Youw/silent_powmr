...
For example: `Assisted-by: claude-code:claude-opus-4-8` or
...
- Branch names should be explicit and brief about what is being done or asked — e.g. `add-auto-fan-control`, `fix-modbus-byte-order`, etc.
- Prefer kebab-case.
